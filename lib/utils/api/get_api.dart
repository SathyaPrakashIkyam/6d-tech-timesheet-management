...
//Get Api.
Future fetchGetApiData(String url,BuildContext context ) async {
  // SharedPreferences prefs = await SharedPreferences.getInstance();
  //
    ...
    try {
      ...
      if (responseBody.runtimeType.toString() != "List<dynamic>") {
        ...
        if (responseBody.containsKey("error")) {
          ...
          Navigator.of(context as BuildContext).pushReplacement(PageRouteBuilder(pageBuilder: (context, animation, secondaryAnimation) =>const MyApp(),));
         return '';
        } else {
          return responseBody;
        }
