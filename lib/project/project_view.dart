                                        ...
                                        const SizedBox(height: 18,),
                                         Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children:   [
                                              const Text("Project Details : ", style: TextStyle(color: Colors.indigo, fontSize: 22, fontWeight: FontWeight.bold),),
                                              Text(project["name"] ?? "", style: const TextStyle(color: Colors.black, fontSize: 18, fontWeight: FontWeight.bold),),
                                            ],
                                          ),
                                        ),
